      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-advance-primary/10 to-advance-secondary/10 rounded-3xl flex items-center justify-center">
              <div className="text-center space-y-4">
                <div className="w-32 h-32 bg-advance-primary/20 rounded-2xl mx-auto flex items-center justify-center">
                  <div className="w-16 h-16 bg-advance-primary rounded-xl"></div>
                </div>
